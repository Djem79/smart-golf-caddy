...
| 2 | Sign in with Apple | ВКЛЮЧЕНО 02.09.2026: App ID + capability, Services ID, ключ, провайдер в Firebase (с OAuth code flow), веб задеплоен с кнопкой. Осталась ЖИВАЯ ПРОВЕРКА по чек-листу SETUP.md §5 (вход веб/iOS, «Скрыть e-mail», связывание, удаление с отзывом) |
